...
from robot_lab.assets.dolangd2 import DOLANGD2_CFG  # isort: skip


@configclass
class DolangD2RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = DOLANGD2_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        self.scene.contact_forces.prim_path = "{ENV_REGEX_NS}/Robot/.*_link"
        self.scene.height_scanner.prim_path = "{ENV_REGEX_NS}/Robot/" + self.base_link_name
        self.scene.height_scanner_base.prim_path = "{ENV_REGEX_NS}/Robot/" + self.base_link_name
        self.scene.height_scanner_fl_foot.prim_path = "{ENV_REGEX_NS}/Robot/left_ankle_roll_link"
        self.scene.height_scanner_fr_foot.prim_path = "{ENV_REGEX_NS}/Robot/right_ankle_roll_link"
        self.scene.height_scanner_hl_foot.prim_path = "{ENV_REGEX_NS}/Robot/left_ankle_roll_link"
        self.scene.height_scanner_hr_foot.prim_path = "{ENV_REGEX_NS}/Robot/right_ankle_roll_link"
        ...
        self.rewards.create_joint_deviation_l1_rewterm(
            "joint_deviation_torso_head_l1",
            -0.03,
            ["truck_joint", "neck_joint", "head_joint"],
        )
        ...
        if self.__class__.__name__ == "DolangD2RoughEnvCfg":
        ...
        self.commands.base_velocity.small_command_threshold = 0.0
