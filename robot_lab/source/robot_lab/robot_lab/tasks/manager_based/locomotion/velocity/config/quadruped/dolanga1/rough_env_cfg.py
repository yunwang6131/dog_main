...
class Dolanga1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        terrain_generator.sub_terrains["flat"].proportion = 0.15 #0.10
        terrain_generator.sub_terrains["pyramid_stairs"].proportion = 0.2 #0.25
        terrain_generator.sub_terrains["pyramid_stairs"].step_height_range = (0.04, 0.25) #0.16
        terrain_generator.sub_terrains["pyramid_stairs_inv"].proportion = 0.2  #0.25
        terrain_generator.sub_terrains["pyramid_stairs_inv"].step_height_range = (0.04, 0.25)
        terrain_generator.sub_terrains["boxes"].proportion = 0.25 #0.25
        terrain_generator.sub_terrains["boxes"].grid_height_range = (0.025, 0.10) #0.08
