...
@configclass
class DolangH1RoughDreamWaQRunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class DolangH1FlatDreamWaQRunnerCfg(DolangH1RoughDreamWaQRunnerCfg):
    def __post_init__(self):
        super().__post_init__()
        self.max_iterations = 5000
        self.experiment_name = "dolangh1_flat_dreamwaq"
        self.obs_groups = {
            "actor": PROPRIO_GROUPS,
...
@configclass
class DolangH1RoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class DolangH1FlatPPORunnerCfg(DolangH1RoughPPORunnerCfg):
    def __post_init__(self):
        super().__post_init__()
