...
class DreamWaQPPO(PPO):
    ...
    def update(self) -> dict[str, float]:
        ...
        for batch in generator:
            ...
            mean_cenet_terrain_loss += getattr(cenet_loss, "terrain", torch.zeros((), device=self.device)).item()
        ...
        mean_cenet_terrain_loss /= num_updates
        if mean_rnd_loss is not None:
        ...
        loss_dict = {
            ...
            "cenet_terrain": mean_cenet_terrain_loss,
        }
        if self.rnd:
