...
from robot_lab.third_party.rsl_rl_barrier_dual.models import export_barrier_dreamwaq_merged_jit_from_runner
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    if is_est_runner:
        ...
        export_barrier_dreamwaq_merged_jit_from_runner(runner, export_model_dir)
    else:
