...
class RewardManager(ManagerBase):
    ...
    def compute(self, dt: float) -> torch.Tensor:
        ...
        for term_idx, (name, term_cfg) in enumerate(zip(self._term_names, self._term_cfgs)):
            ...
            self.current_reward_dict[name] = value
    ...
    def get_current_reward_dict(self) -> dict[str, torch.Tensor]:
        """Returns the current reward dictionary.

        Returns:
            The current reward dictionary.
        """
        return self.current_reward_dict
